...
// ======================================================================================
//  Macro: Fill coefficients for a CHARACTERISTIC BC 
//
//  Engquist Majda BC:
    ...
    // *****************************************************
      ...
      // **** NEW WAY ****
          ...
          // ---- Engquist-Majda radiation boundary condition ----
              ...
              // printF("[side,axis]=[%d,%d] FILL CHARACTERISTIC RBC psiStart=%d (is1,is2,is3)=(%d,%d,%d) is=%d\n",side,axis,psiStart,is1,is2,is3,is);
                            Real dx[3]={1.,1.,1.};
                            mg.getDeltaX(dx);
